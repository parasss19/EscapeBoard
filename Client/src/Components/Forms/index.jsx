...
const Forms = ({passGenerator, socket, setUserData}) => {
  return (
    <div className='flex justify-center items-center h-[70vh] my-12 gap-x-36'>
          ...
          <div className="w-[380px] h-60 pt-2 px-4 mt-5 border border-blue-900 rounded-md">
            ...
            <CreateRoom passGenerator={passGenerator} socket={socket} setUserData={setUserData}/>
           </div>

          {/* Right col= Join Room */}
          <div className="w-[380px] h-60 pt-2 px-4 mt-5 border border-blue-900 rounded-md">
            <h1 className=' text-center font-mono text-3xl text-blue-900 font-bold'>Join Room</h1> 
            <JoinRoom passGenerator={passGenerator} socket={socket} setUserData={setUserData}/>
          </div>
    </div>
  )
}
